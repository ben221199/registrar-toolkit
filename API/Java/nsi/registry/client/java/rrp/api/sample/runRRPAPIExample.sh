...
#
# Base directory where Java is installed (i.e. directory that contains
# bin/javac and lib/classes.zip)
#
JAVAHOME="/usr/local/jdk1.1.7"

if [ ! -x "$JAVAHOME/bin/javac" ]; then 
	echo ; echo "#######################";
	echo "JAVA ENVIRONMENT ERROR!";
	echo "#######################";
	echo ; echo "Cannot locate executable Java compiler.";
	echo "Please make sure that 'JAVAHOME' variable is";
...
BASEDIR="../../../../../../.."
CLASSPATH="${BASEDIR}:${JAVAHOME}/lib/classes.zip:."
...
# Run application
#
$JAVAHOME/bin/java RRPAPIExample
